...
| <a name="input_task_memory"></a> [task\_memory](#input\_task\_memory) | Memory to allocate, in MB, valid values here, should correlate to `task_cpu`: https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-cpu-memory-error.html | `number` | `800` | no |
